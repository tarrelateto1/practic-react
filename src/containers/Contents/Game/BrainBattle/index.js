...
//register image
import register1 from 'src/assets/BrainBattle/register/register1.jpeg'

//code image
import code1 from 'src/assets/BrainBattle/moneyCode/code1.jpeg'
import code2 from 'src/assets/BrainBattle/moneyCode/code2.jpeg'
import code3 from 'src/assets/BrainBattle/moneyCode/code3.jpeg'

//redeem image
import redeem1 from 'src/assets/BrainBattle/redeem/redeem1.jpeg'
import redeem2 from 'src/assets/BrainBattle/redeem/redeem2.jpeg'
        ...
        <div className="site-layout-background" style={{ padding: 24, minHeight: 360, margin: '24px 16px 0' }}>
            <Row justify="start" >
                ...
                <p>คำอธิบายแอพริเคชั่น : เป็นการคิดเลขเก็บเงิน</p>
                    <p>รองรับโทรศัพท์ : ทั้ง Android และ IOS (IOS ยังมีปัญหาในการถอนเงิน)</p>
                {/*<p>รูปเรียงกัน </p>*/}
                {/*<h3>โค้ดรับเงิน</h3>*/}
                {/*<p>รูปเรียงกัน </p>*/}
                {/*<h3>วิธีแลกเงิน</h3>*/}
